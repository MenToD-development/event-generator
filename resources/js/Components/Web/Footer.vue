        ...
        <div class="mx-auto max-w-7xl py-12 px-6 lg:py-16 lg:px-8">
            <div class="xl:grid xl:grid-cols-3 xl:gap-8">
                ...
                <div class="mt-8 xl:mt-0">
                    <h3 class="text-base font-semibold text-white">Inschrijven voor de nieuwsbrief</h3>
                    <p class="mt-4 text-base text-gray-300">Ontvang elke maand het laatste nieuws over Eavent.</p>
            ...
            <div class="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
                ...
                <p class="mt-8 text-base text-gray-400 md:order-1 md:mt-0">&copy; 2023 MenToD, Inc. All rights reserved.</p>
            </div>
        </div>
    </footer>
</template>
