...
import UiButton from "../Atoms/Buttons/UiButton.vue";
...
<template>
    <Popover class="fixed w-screen bg-white/50 z-10 backdrop-blur-md bg-transparent">
        <div class="flex items-center justify-between px-4 py-6 sm:px-6 md:justify-start md:space-x-10">
            <div class="flex justify-start lg:w-0 lg:flex-1">
                <a href="#">
                    <span class="sr-only">Event Generator</span>
                    <span class="font-sans text-2xl font-bold text-slate-800">
                        EAVENT
                    </span>
                </a>
            </div>
            ...
            <PopoverGroup as="nav" class="hidden space-x-10 md:flex">
                <Popover class="relative" v-slot="{ open }">
                    <PopoverButton :class="[open ? 'text-gray-900' : 'text-gray-500', 'group inline-flex items-center rounded-md text-base font-medium hover:text-gray-900 focus:outline-none']">
                        <span>Solutions</span>
            ...
            <div class="hidden items-center justify-end space-x-3 md:flex md:flex-1 lg:w-0">
                <a href="#">
                    <ui-button fill="white" size="lg">
                        Inloggen
                    </ui-button>
                </a>
                <a href="#">
